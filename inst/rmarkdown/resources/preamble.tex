...
\hypersetup{
    colorlinks = true,
    linkcolor  = customBrown,
    urlcolor   = customBrown,
    citecolor = customBrown
}
...
\newcommand{\localtextbulletone}{\textcolor{customBlue}{\raisebox{.45ex}{\rule{.6ex}{.6ex}}}}
\renewcommand{\labelitemi}{\localtextbulletone}

% Update styles to match guide
\renewcommand{\emph}[1]{\textit{\textcolor{customBrown}{#1}}}
...
\newenvironment{tip}
  {\begin{customBlockImage}[colframe=customGrey]{LOCALFILEPATH/images/tip}}
  {\end{customBlockImage}}
\newenvironment{question}
  {\begin{customBlockImage}[colframe=customWhite, colback=customWhite]{LOCALFILEPATH/images/question}}
  {\end{customBlockImage}}
...
\newenvironment{rmdnote}
  {\begin{customBlockImage}{LOCALFILEPATH/images/note}}
  {\end{customBlockImage}}
\newenvironment{rmdcaution}
  {\begin{customBlockImage}{LOCALFILEPATH/images/caution}}
  {\end{customBlockImage}}
\newenvironment{rmdimportant}
  {\begin{customBlockImage}{LOCALFILEPATH/images/important}}
  {\end{customBlockImage}}
\newenvironment{rmdtip}
  {\begin{customBlockImage}{LOCALFILEPATH/images/tip}}
  {\end{customBlockImage}}
\newenvironment{rmdwarning}
  {\begin{customBlockImage}{LOCALFILEPATH/images/warning}}
  {\end{customBlockImage}}
