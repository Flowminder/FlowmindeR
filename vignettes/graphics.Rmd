---
title: "Flowminder Visual and Data cookbook for R graphics"
...
## How to create Flowminder style graphics
...
This document is shamelessly adpated from the BBC style guide: https://bbc.github.io/rcookbook/

# About the style

- Title font set to the **Merriweather font**
- Colour palette

```{r}
scales::show_col(c("#BDAC90", "#095798", "#FAAD61", "#ADD8A4", "#C11D1D"))
```
...
`FlowmindeR` is not on CRAN, so you will have to install it directly from Github using `devtools`. 
...
line <- ggplot(line_df, aes(x = year, y = lifeExp)) +
  ...
  theme(panel.grid.major.x = element_line(color="pink"), 
        panel.grid.major.y=element_blank())
